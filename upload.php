...
<body>
  ...
  <div class="title">
    ...
    <div class="forms jumbotron">
      ...
      <form class="uploaddetails" action="confirm.php" method="post">
        <input type="text" name='filename' value="<?php echo $filename ?>" readonly> <br>
        <label for="name">Name of The Work</label>
        <input type="text" name="name" placeholder="Name"><br>
        <label for="database">Database Number</label>
        <input type="text" name="database" placeholder="Database Number"><br>
        <label for="scene">Scene Number</label>
        <input type="text" name="scene" placeholder="Scene Number"><br>
        <label for="style">In style of</label>
        <input type="text" name="style" placeholder="Artist Name"><br>
